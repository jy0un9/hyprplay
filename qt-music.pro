...
unix {
    ...
    uninstall.commands = -$(DEL_FILE) $(INSTALL_ROOT)$$PREFIX/lib/qt-music/$(QMAKE_TARGET) $(INSTALL_ROOT)$$PREFIX/bin/qt-music $(INSTALL_ROOT)$$PREFIX/share/applications/qt-music.desktop $(INSTALL_ROOT)$$PREFIX/share/icons/hicolor/scalable/apps/qt-music.svg $(INSTALL_ROOT)$$PREFIX/share/icons/hicolor/256x256/apps/qt-music.png $(INSTALL_ROOT)$$PREFIX/share/icons/hicolor/128x128/apps/qt-music.png
