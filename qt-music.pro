...
unix {
    ...
    install.commands = $(MKDIR) $(INSTALL_ROOT)$$PREFIX/lib/qt-music && rm -f $(INSTALL_ROOT)$$PREFIX/lib/qt-music/$(QMAKE_TARGET) && cp -f $(QMAKE_TARGET) $(INSTALL_ROOT)$$PREFIX/lib/qt-music/$(QMAKE_TARGET) && chmod 755 $(INSTALL_ROOT)$$PREFIX/lib/qt-music/$(QMAKE_TARGET) && $(MKDIR) $(INSTALL_ROOT)$$PREFIX/bin && rm -f $(INSTALL_ROOT)$$PREFIX/bin/qt-music && cp -f $$PWD/qt-music $(INSTALL_ROOT)$$PREFIX/bin/qt-music && chmod 755 $(INSTALL_ROOT)$$PREFIX/bin/qt-music && $(MKDIR) $(INSTALL_ROOT)$$PREFIX/share/applications && cp -f $$PWD/desktop/qt-music.desktop $(INSTALL_ROOT)$$PREFIX/share/applications/qt-music.desktop && sh $$PWD/desktop/fix-desktop-exec.sh $(INSTALL_ROOT)$$PREFIX/share/applications/qt-music.desktop $$PREFIX && $(MKDIR) $(INSTALL_ROOT)$$PREFIX/share/metainfo && cp -f $$PWD/desktop/ai.commandcode.qt-music.metainfo.xml $(INSTALL_ROOT)$$PREFIX/share/metainfo/ai.commandcode.qt-music.metainfo.xml && $(MKDIR) $(INSTALL_ROOT)$$PREFIX/share/icons/hicolor/scalable/apps && cp -f $$PWD/desktop/icons/hicolor/scalable/apps/qt-music.svg $(INSTALL_ROOT)$$PREFIX/share/icons/hicolor/scalable/apps/qt-music.svg && $(MKDIR) $(INSTALL_ROOT)$$PREFIX/share/icons/hicolor/256x256/apps && cp -f $$PWD/desktop/icons/hicolor/256x256/apps/qt-music.png $(INSTALL_ROOT)$$PREFIX/share/icons/hicolor/256x256/apps/qt-music.png && $(MKDIR) $(INSTALL_ROOT)$$PREFIX/share/icons/hicolor/128x128/apps && cp -f $$PWD/desktop/icons/hicolor/128x128/apps/qt-music.png $(INSTALL_ROOT)$$PREFIX/share/icons/hicolor/128x128/apps/qt-music.png
    install.depends = first
    QMAKE_EXTRA_TARGETS += install

    uninstall.target = uninstall
    uninstall.commands = -$(DEL_FILE) $(INSTALL_ROOT)$$PREFIX/lib/qt-music/$(QMAKE_TARGET) $(INSTALL_ROOT)$$PREFIX/bin/qt-music $(INSTALL_ROOT)$$PREFIX/share/applications/qt-music.desktop $(INSTALL_ROOT)$$PREFIX/share/metainfo/ai.commandcode.qt-music.metainfo.xml $(INSTALL_ROOT)$$PREFIX/share/icons/hicolor/scalable/apps/qt-music.svg $(INSTALL_ROOT)$$PREFIX/share/icons/hicolor/256x256/apps/qt-music.png $(INSTALL_ROOT)$$PREFIX/share/icons/hicolor/128x128/apps/qt-music.png
